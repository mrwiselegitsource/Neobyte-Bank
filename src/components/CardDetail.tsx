...
import { ArrowLeft, Shield, Sparkles, CheckCircle2, ChevronRight, Sliders, HelpCircle } from 'lucide-react';
...
export const CardDetail: React.FC<CardDetailProps> = ({
  ...
  const [customHolder, setCustomHolder] = useState(card.accountHolder);
  ...
  useEffect(() => {
    setCustomHolder(loggedInName || card.accountHolder);
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-zinc-950 p-5 rounded-2xl border border-zinc-900 space-y-4">
              <div className="flex items-center space-x-2 border-b border-zinc-900 pb-2.5">
                ...
                <h4 className="text-white text-xs font-bold uppercase tracking-wider font-mono">Customize Parameters</h4>
              </div>
          ...
          <div className="lg:col-span-7 bg-zinc-950/80 border border-zinc-900 rounded-2xl p-6 space-y-6">
            ...
            <div className="border border-zinc-900 rounded-xl overflow-hidden text-xs font-sans">
              ...
              <div className="grid grid-cols-2 border-b border-zinc-900 py-2.5 px-4">
                ...
                <span className="text-white text-right truncate font-bold uppercase">{customHolder}</span>
              </div>
              <div className="grid grid-cols-2 border-b border-zinc-900 py-2.5 px-4 bg-zinc-950/40">
